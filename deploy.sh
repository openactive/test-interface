...
# Regenerate markdown file only
node ./node_modules/extension-documentation-generator/index.js test-interface.jsonld header.md > ./out/index.md
cp test-interface.jsonld ./out/
